...
int main() {
    ...
    std::string replacement2 = R"(<div itemscope="" itemtype="http://schema.org/Person" class="profile_box" style="padding-left: 1.5rem;padding-right: 1rem;"><div class="author__avatar"><img src="https://coderbak.com/document/avatar.png" class="author__avatar"></div>
