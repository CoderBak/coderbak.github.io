...
int main() {
  ...
  <div class="author__urls-wrapper">
    ...
    <ul class="author__urls social-icons" style="">
        <li><div style="white-space: normal; margin-bottom: 1.3em;">「Je pense, donc je suis. 」
        </div></li>
    </ul>
    <div style="display: flex; gap: 19px;">
    <a href="https://scholar.google.com/citations?user=8WMS544AAAAJ" title="scholar" class="social_icons" style="text-decoration: none; align-items: center;">
